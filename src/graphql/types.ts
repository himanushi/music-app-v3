...
export type ChangeFavoritesInput = {
  ...
  /** お気に入り変更したいラジオID */
  readonly radioIds?: Maybe<ReadonlyArray<Scalars['TTID']>>;
...
export type Favorite = {
  ...
  /** ラジオID */
  readonly radioIds: ReadonlyArray<Scalars['String']>;
  /** トラックID */
...
export type CurrentUserFieldsFragment = (
  ...
  & { readonly publicInformations: ReadonlyArray<Pick<PublicInformation, 'id' | 'publicType'>>, readonly role: Pick<Role, 'id' | 'name' | 'description' | 'allowedActions'>, readonly favorite: Pick<Favorite, 'albumIds' | 'artistIds' | 'trackIds' | 'playlistIds' | 'radioIds'> }
);
...
export type ChangeStatusMutation = { readonly changeStatus?: Maybe<Pick<ChangeStatusPayload, 'result'>> };
...
export type IgnoreAlbumsMutation = { readonly ignoreAlbums?: Maybe<{ readonly albums?: Maybe<ReadonlyArray<Pick<Album, 'id' | 'name'>>> }> };
...
export type IgnoreArtistsMutation = { readonly ignoreArtists?: Maybe<{ readonly artists?: Maybe<ReadonlyArray<Pick<Artist, 'id' | 'name'>>> }> };
...
export type UpsertAlbumMutationVariables = Exact<{
  input: UpsertAlbumInput;
}>;


export type UpsertAlbumMutation = { readonly upsertAlbum?: Maybe<{ readonly albums?: Maybe<ReadonlyArray<Pick<Album, 'id' | 'name'>>> }> };
...
export const ChangeStatusDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ChangeStatus"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ChangeStatusInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"changeStatus"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"result"}}]}}]}}]} as unknown as DocumentNode<ChangeStatusMutation, ChangeStatusMutationVariables>;
...
export const UpsertAlbumDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpsertAlbum"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpsertAlbumInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"upsertAlbum"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"albums"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]}}]} as unknown as DocumentNode<UpsertAlbumMutation, UpsertAlbumMutationVariables>;
