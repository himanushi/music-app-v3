...
export type UpdateAlbumMutation = { readonly updateAlbum?: Maybe<{ readonly albums?: Maybe<ReadonlyArray<Pick<AlbumObject, 'id' | 'name'>>> }> };
...
export type PlaylistsQuery = { readonly items?: Maybe<ReadonlyArray<(
    Pick<PlaylistObject, 'id' | 'name' | 'createdAt' | 'updatedAt'>
